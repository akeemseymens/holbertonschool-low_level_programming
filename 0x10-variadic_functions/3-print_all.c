...
/**
 * op_char - convert symbol into function
...
/**
 * op_int - convert symbol into function
 * @list: string which may correspoind to function
 *
 * Return: function associated with s
 */
...
/**
 * op_float - convert symbol into function
 * @list: string which may correspoind to function
 *
 * Return: function associated with s
 */
...
/**
 * op_char_ptr - convert symbol into function
 * @list: string which may correspoind to function
 *
 * Return: function associated with s
 */
...
/**
 * print_all - convert symbol into function
 * @format: pointer char.
 *
 * Return: function associated with s
 */
